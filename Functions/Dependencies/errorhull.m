...
checkField(P,'Marker','none');
checkField(P,'MarkerSize',10);
...
if ~strcmp(P.LineStyle,'none')
  h(1) = plot(X,M,'Color',P.Color,'LineWidth',P.LineWidth,'LineStyle',P.LineStyle,'Marker',P.Marker,'MarkerSize',P.MarkerSize);
else h(1) = NaN;
end